({
    doInit: function(component) {
        ...
        //             component.set("v.objectPluralLabel", component.get("v.label"));
        //         }
        ...
        console.log("objectTypev::" + component.get("v.objectType"));
    ...
    clear :function(component,event,heplper){
     ...
     clearByButton :function(component,event,heplper){
    	if (component.get("v.clearFlg")) {
    		component.set("v.searchIsActive", true );  
    		...
    		component.set("v.searchKeyWord", null);
    		component.set("v.listOfSearchRecords", null );
    		component.set("v.clearFlg",false);
    	}
    },
    ...
    changeRecordId : function(component, event, helper){
        if($A.util.isEmpty(component.get("v.selectedRecordId")) || $A.util.isEmpty(component.get("v.selectedRecordTitle"))){
            return;
        }
        component.set("v.searchIsActive", false );
        component.set("v.searchKeyWord", "");
